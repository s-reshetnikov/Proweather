...
import by.reshetnikov.proweather.data.network.model.location.LocationWeather;
...
public class ModelsConverter {
    ...
    public static LocationAppModel createLocationAppModel(LocationEntity entity) {
        ...
        appModel.setPosition(entity.getPosition());
    ...
    public static LocationEntity createLocationEntity(LocationAppModel appModel) {
        ...
        entity.setPosition(appModel.getPosition());
